...
def basic_series() -> pd.Series:
    ...
    """
    return pd.Series([n + 1 for n in range(5)], name='Fred')
...
def float_series() -> pd.Series:
    ...
    """
    return pd.Series([n / 1000 for n in range(1001)])
...
def alpha_index_series() -> pd.Series:
    ...
    """
    return pd.Series([n + 1 for n in range(26)], index=[chr(97 + n) for n in range(26)])
...
def object_values_series() -> pd.Series:
    ...
    Don't worry about the series name.
    """
    return pd.Series([chr(65 + n) for n in range(26)], index=[n + 101 for n in range(26)])
